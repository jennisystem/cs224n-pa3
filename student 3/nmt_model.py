...
class NMT(nn.Module):
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        # 1. Appy decoder to Ybar_t and dec_state to get the new dec_state
        dec_state = self.decoder(Ybar_t, dec_state)

        # 2. Split dec_state into 2 parts
        ...
        #3. Concatenate to compute tensor U_t
        U_t = torch.cat((a_t, dec_hidden), dim=1)

        # 4. Apply combined output projection layer to compute V_t
